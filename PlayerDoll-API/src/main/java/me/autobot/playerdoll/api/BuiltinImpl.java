...
public final class BuiltinImpl {
    ...
    private void registerServerVersion() {
        ...
        AbsServerVersion.v1_21_R4 = new AbsServerVersion(770) {
            @Override
            public String registerVersion() {
                return "v1_21_R4";
            }
            ...
            @Override
            public boolean match(String ver) {
                return ver.matches("1\\.21\\.5");
            }
        };
        AbsServerVersion.v1_21_R5 = new AbsServerVersion(771) {
            @Override
            public String registerVersion() {
                return "v1_21_R5";
            }
            ...
            @Override
            public boolean match(String ver) {
                return ver.matches("1\\.21\\.6");
            }
        };
        AbsServerVersion.v1_21_R6 = new AbsServerVersion(772) {
            @Override
            public String registerVersion() {
                return "v1_21_R6";
            }
            ...
            @Override
            public boolean match(String ver) {
                return ver.matches("1\\.21\\.7|1\\.21\\.8");
            }
        };
        AbsServerVersion.v1_21_R7 = new AbsServerVersion(773) {
            @Override
            public String registerVersion() {
                return "v1_21_R7";
            }
            ...
            @Override
            public boolean match(String ver) {
                return ver.matches("1\\.21\\.9|1\\.21\\.10");
            }
        };
        AbsServerVersion.v1_21_R8 = new AbsServerVersion(774) {
            @Override
            public String registerVersion() {
                return "v1_21_R8";
            }
