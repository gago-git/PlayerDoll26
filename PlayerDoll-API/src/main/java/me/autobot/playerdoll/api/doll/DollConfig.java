...
public final class DollConfig extends AbstractConfig {
    ...
    public final ConfigKey<DollConfig, String> lastWorld;
    public final ConfigKey<DollConfig, Double> lastX;
    public final ConfigKey<DollConfig, Double> lastY;
    public final ConfigKey<DollConfig, Double> lastZ;
    public final ConfigKey<DollConfig, Double> lastYaw;
    public final ConfigKey<DollConfig, Double> lastPitch;
    // cached these 4
    ...
    private DollConfig(File file) {
        ...
        this.lastWorld = new ConfigKey<>(this, "Last-Location.world", "");
        this.lastX = new ConfigKey<>(this, "Last-Location.x", 0.0D);
        this.lastY = new ConfigKey<>(this, "Last-Location.y", 0.0D);
        this.lastZ = new ConfigKey<>(this, "Last-Location.z", 0.0D);
        this.lastYaw = new ConfigKey<>(this, "Last-Location.yaw", 0.0D);
        this.lastPitch = new ConfigKey<>(this, "Last-Location.pitch", 0.0D);
    ...
    public void setLastLocation(Location location) {
        ...
        lastWorld.setNewValue(location.getWorld().getName());
        lastX.setNewValue(location.getX());
        lastY.setNewValue(location.getY());
        lastZ.setNewValue(location.getZ());
        lastYaw.setNewValue((double) location.getYaw());
        lastPitch.setNewValue((double) location.getPitch());
    }

    public Location getLastLocation() {
        String worldName = lastWorld.getValue();
        ...
        return new Location(world, lastX.getValue(), lastY.getValue(), lastZ.getValue(), lastYaw.getValue().floatValue(), lastPitch.getValue().floatValue());
    }
