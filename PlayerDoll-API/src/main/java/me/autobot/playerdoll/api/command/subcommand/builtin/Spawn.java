...
public class Spawn extends SubCommand implements DollCommandExecutor {
    ...
    public int onCommand(CommandSender sender, CommandContext<Object> context) {
        ...
        profile = ReflectionUtil.createGameProfileWithTextures(
                targetUUID,
                basicConfig.dollIdentifier.getValue() + targetString,
                offlineConfig.skinProperty.getValue(),
                offlineConfig.skinSignature.getValue()
        );
